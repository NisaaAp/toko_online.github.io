...
<body>
    <?php
        include "navbar.php";
        include "koneksi.php";
        $query_detail_produk = mysqli_query($koneksi, "SELECT * FROM toko_produk where id_produk = '".$_GET['id_produk']."'");
        $data_produk = mysqli_fetch_array($query_detail_produk);
    ?>
    <main class="container">
    <section class="py-5 text-center container">
        <div class="col-lg-6 col-md-8 mx-auto">
            <h1 class="fw-light">Beli Produk</h1>
        </div>
    </section>
    ...
    <div class="card mb-3" style="max-width: 100%;">
        <div class="row g-0">
            <div class="col-md-4">
            <img src="../admin/foto/<?=$data_produk['foto_produk']?>" class="img-fluid rounded-start" alt="...">
            </div>
            <div class="col-md-8">
            <div class="card-body">
